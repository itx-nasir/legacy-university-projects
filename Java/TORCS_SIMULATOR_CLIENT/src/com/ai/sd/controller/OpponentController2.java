...
//	static double relativeSpeedPrevious = 0.0;
	...
	public static void opponentPositionsUpdater(MySensorModel sensors, ControllersDriver myPara){
	...
	public static void opponentsInfoUpdater(MySensorModel sensors, ControllersDriver myPara){
	...
	public static  double[] opponentsDirectionUpdater(MySensorModel sensors, double steer, double s, double correctionSensors, Stage stage, ControllersDriver myPara){
...
//		System.out.println("Manouver: " + manouver+", directionAlter: "+directionAlt+", pos: "+trackPos+", where: "+whereToGo);
	...
	public static double opponentSpeedReviser(MySensorModel sensors, double targetSpeed, double estimatedTurn, double distInfront, double steer, ControllersDriver myPara){
