...
public class MessageParser {
    ...
    public void printAll() {
        ...
        File myFile = new File("TrainingInput.txt");
		PrintWriter pw = null ;
		try {
		...
		while (keys.hasMoreElements()) {
        	...
        	if (key.equals("angle") || key.equals("gear") || key.equals("rpm") ||
        			key.equals("speedX") || key.equals("speedY") || key.equals("speedZ") ||
        			key.equals("trackPos") || key.equals("wheelSpinVel") || key.equals("z")
        		){
