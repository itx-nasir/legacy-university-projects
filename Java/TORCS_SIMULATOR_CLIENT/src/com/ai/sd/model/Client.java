...
import com.ai.sd.controller.ControllersDriver;
...
public class Client {
	...
	public static void main(String[] args) {
		...
		ControllersDriver para = new ControllersDriver(stage, level);
		para.setStage(stage);
		para.setLevel(level);
	...
	public static boolean runClient(String[] args, ControllersDriver para) {
		...
		File myFile = new File("TrainningInput.txt");
		PrintWriter pw = null ;
		File myFile1 = new File("TrainningOutput.txt");
